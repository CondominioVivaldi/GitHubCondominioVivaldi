        ...
        {reservas.length > 0 && (
          <div className="mb-4 flex justify-between items-center">
            ...
            <button
              ...
              className={`flex items-center gap-2 px-4 py-2 rounded-lg Mi_texto_boton transition duration-300 ${
                selectedReservas.size === 0 || isLoading
                  ? "bg-gray-300 text-gray-500 cursor-not-allowed"
                  : "bg-mi-gradiente-boton-principal text-[var(--Mi-blanco)] hover:opacity-90 hover:shadow-lg"
              }`}
            >
